<%@ Page Title="" Language="C#" MasterPageFile="~/Areas/Admin/Admin_MasterPage.master" AutoEventWireup="true" CodeFile="Manage_NewsCategory_Insert.aspx.cs" Inherits="Areas_Admin_Manage_NewsCategory_Insert" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="content_Admin" runat="Server">
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>Thêm mới danh mục tin tức
            </h1>
            <i class="fa fa-uses fa-fw bg-black"></i>
            <ol class="breadcrumb">
                <li><i class="fa fa-users"></i>Thêm mới danh mục tin tức</li>
        ...
        <section class="content">
            ...
            <div class="row">
                <div class="col-lg-4">
                    ...
                    <asp:Button runat="server" ID="btn_Add_NewsCategory" OnClick="btn_Add_NewsCategory_Click" CssClass="btn btn-primary" Text="Lưu" />
                </div>
                <div class="col-lg-8">
