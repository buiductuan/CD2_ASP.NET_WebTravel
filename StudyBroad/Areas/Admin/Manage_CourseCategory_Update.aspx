<%@ Page Title="" Language="C#" MasterPageFile="~/Areas/Admin/Admin_MasterPage.master" AutoEventWireup="true" CodeFile="Manage_CourseCategory_Update.aspx.cs" Inherits="Areas_Admin_Manage_CourseCategory_Update" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="content_Admin" runat="Server">
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>Sửa danh mục khóa học
            </h1>
            <i class="fa fa-uses fa-fw bg-black"></i>
            <ol class="breadcrumb">
                <li><i class="fa fa-users"></i>Sửa danh mục khóa học</li>
        ...
        <section class="content">
            ...
            <div class="row">
                <div class="col-lg-4">
                    ...
                    <asp:Button runat="server" ID="btn_Update_CourseCategory" OnClick="btn_Update_CourseCategory_Click" CssClass="btn btn-primary" Text="Lưu" />
                </div>
                <div class="col-lg-8">
...
<%--                            <div class="row">
            ...
            <div class="row">
                ...
                <div class="col-lg-8">
                    <div class="panel panel-default">
                        <div class="panel-body">
                            <asp:RadioButtonList runat="server" ID="rbl_Category_Course">
